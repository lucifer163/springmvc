...
/*
 * 添加收藏 <a title="收藏本站" href="javascript:addFavoritepage(0);">收藏本站</a>
 */
...
$(function() {
	...
	/* tag标签 */
	var $that = $(".hui-tags"), $taginput = $that.find(".hui-tags-input"), $taglable = $that
			.find(".hui-tags-lable"), $tagswp = $that.find(".hui-tags-iptwrap"), $taglist = $that
			.find(".hui-tags-list"), $taghas = $taglist.find(".hui-tags-has"), time1;
	$taglable.show();
	$taginput.val("");
